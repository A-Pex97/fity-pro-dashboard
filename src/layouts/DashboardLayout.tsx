            ...
            <aside className="w-64 border-r border-dark-border bg-dark-panel flex flex-col justify-between">
                ...
                <div className="p-4 border-t border-dark-border">
                    <button onClick={handleLogout}
                        className="flex items-center gap-3 w-full px-3 py-2.5 text-sm font-medium text-gray-400 hover:text-red-400 hover:bg-red-400/10 rounded-lg transition-colors">
